...
class KTBM_DataLoader:
    ...
    def generate_train_test_data(self, data):
        ...
        self.train_data_q, self.train_data_a, self.train_data_l, self.train_data_d = self.ML_BH_ExtDataset(q_records,
                                                                                                       a_records,
                                                                                                       l_records,
                                                                                                       d_records,
                                                                                                       self.max_seq_len,
        ...
        if self.mode == "train":
            ...
            self.test_data_q, self.test_data_a, self.test_data_l, self.test_data_d = self.ML_BH_ExtDataset(q_records,
                                                                                                          a_records,
                                                                                                          l_records,
                                                                                                          d_records,
                                                                                                          self.max_seq_len,

...
import warnings
from model.KTBM import KTBM
from dataloader.dataloader import KTBM_DataLoader
...
class trainer(object):
    def __init__(self, config, data, ref_vec, pref_idx):
        ...
        self.test_roc_auc_type_list = []
        self.test_pr_auc_type_list = []
        self.test_rmse_list = []
        ...
        self.data_loader = KTBM_DataLoader(config, data)
        self.model = KTBM(config)
